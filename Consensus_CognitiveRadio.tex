...
\title{Multi-preferential consensus parameters setting selection for cognitive wireless sensor networks}
...
\begin{IEEEkeywords}
Cognitive Radio, adaptive modulation, Wireless sensor networks, consensus.
\end{IEEEkeywords}
